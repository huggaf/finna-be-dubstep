...
ActiveRecord::Base.transaction do
  ...
  pablo = User.create!(name: 'Pablo Targa', email: 'pablo.targa@gmail.com', password: '123', password_confirmation: '123')
  bruce = User.create!(name: 'Bruce Wayne', email: 'pablotarga.@gmail.com', password: '123', password_confirmation: '123')
  clark = User.create!(name: 'Clark Kent', email: 'pablotarga..@gmail.com', password: '123', password_confirmation: '123')
  alan  = User.create!(name: 'Alan Scott', email: 'pablotarga...@gmail.com', password: '123', password_confirmation: '123')

  bruce.articles.create! title: "Batman (from Wikipedia)", thumb_url: 'http://www.portaldasnoticias.com/wp-content/uploads/2008/05/darkknightposter12.jpg', color: colors[:info], text: %{
  ...
  clark.articles.create! title: "Superman (from Wikipedia)", thumb_url: 'http://4.bp.blogspot.com/-g0x5fGXGnN8/TuZm9XKTxBI/AAAAAAAANO8/CI7EEMAV5ys/s1600/Superman%2BMan%2Bof%2Bsteel%2Bteaser%2Bposter.jpg', color: colors[:info], text: %{
  ...
  clark.articles.create! title: "Krypton (from Wikipedia)", thumb_url: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQsyPUSUG7YG7WTM2TYQROMt-uoSel3TQuAYo_zxlXuPEfPKq95', color: colors[:success], text: %{
  ...
  clark.articles.create! title: "Lex Luthor (from Wikipedia)", thumb_url: 'http://static.comicvine.com/uploads/original/14/147104/2791937-994719_dc_universe_online_lex_luthor_power_armor_super.png', color: colors[:danger], text: %{
  ...
  bruce.articles.create! title: "Robin (from Wikipedia)", thumb_url: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQ5DwEQKjGQnfdOvBoKuUjyeh8U9_nadnItwa8efKka3S52A4yp', color: colors[:info], text: %{
  ...
  alan.articles.create! title: "Green Lantern (from Wikipedia)", thumb_url: 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSHpVRyuYl2IFSelnduuXXjoL-q5aAHmnnin7YjZitlT_UttPOMtA', color: colors[:success], text: %{
  ...
  alan.articles.create! title: "Alan Scott", thumb_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4Sku1VYDA7IxEHcadYj2B1pcxIAkyYlY4Bhz7oPuG5124ioe6Kg', color: colors[:info], text: %{
